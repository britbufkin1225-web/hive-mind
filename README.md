...
| Repository observer frontend inspector | Implemented | Contextual graph-first dock panel over the snapshot API; no Git dashboard, watcher, persistence, ingestion, AI review, or mutation. |
