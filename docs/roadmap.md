...
**Active phase:** Phase 28C — True Graph-Primary Surface QA + Screenshot
Evidence Refresh. Phase 28C verifies the connected runtime after the Phase
28B implementation and captures fresh, visually re-verified screenshots of
